			...
			<>
				<div id="container">
					...
					<div>
						...
						<p>Supported file extensions pdf|doc|docx|txt|zip|pptx</p>
						<div>
							<div>
								<div>
									<label
							...
							<div>
								<button onClick={uploadToServer}>Generate share link 🔗</button>
							</div>
						</div>
					</div>
				</div>
	...
	return (
		<>
			<div>
				...
				<div>
					<h1>Its an decentralized file share application</h1>
					<ConnectWallet
				...
				{renderMainContent()}
				<footer>© HRV {new Date().getFullYear()}</footer>
			</div>
		</>
	);
}
